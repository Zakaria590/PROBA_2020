...
#Une erreur de ma part, la question 8 demande ce qu'il fallait faire pour être plus rigoureux aux questions 6 et 7 (et non 5 et 6). Ici, on a des temps moyen... mais nous n'avons aucune info sur l'écart-type.... on n'est pas à l'abri d'une erreur à cause des fluctuations des moyennes autours des espérances
#Mais cette question n'est pas si évidente.... une reformulation aurait sans doute été judicieuse :slight_smile:
#Pour la question 9... il fallait se mettre devant le plateau et dénombrer ! Le seul moyen de gagner en 7 coups est de passer par la grande échelle. Pour l'atteindre suffisamment rapidement, il fallait prendre l'échelle 4->14 et éviter tous les serpents et les autres échelles.
#Premier coup : 3 (obligé sinon on perd un coup et on ne gagne pas en 7 coups) pour prendre l'échelle 4->14 suffisamment rapidement

#Les 3 coups d'après possible (pour passer de l'échelle 4->14 à la grande échelle suffisamment rapidement et sans prendre d'autre échelle ou serpent) :
...
4 -> 4 -> 6
2 -> 6 -> 6
#(8 possibilités du coup)

#Et pour les 3 coups finaux on a comme possibilités :
...
#Donc 6*8 possibilités sur 6^7
#D'où une proba de  48/6^7
