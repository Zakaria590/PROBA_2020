...
hist(x, main="Histogramme de la valeur du sinus sur l'intervalle [0;2pi]", xlab="Valeur du sinus", ylab="Fréquence, nombre d'observations")
...
curve(e(3, x), xmin, xmax, main="Représentation de la fonction de densité de la loi exponentielle de paramètre alpha=3", ylab = "3exp(-3x)")
